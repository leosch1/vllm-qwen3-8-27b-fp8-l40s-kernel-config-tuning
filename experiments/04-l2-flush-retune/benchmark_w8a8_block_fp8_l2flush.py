...
# ============================================================
# L2-FLUSH PATCH -- the only diff from vLLM's real, unmodified tuner.
# Everything below this block, and one further call-site change inside
# tune() (benchmark_config_flush instead of benchmark_config), is it.
# ============================================================
...
def benchmark_config_flush(A, B, As, Bs, block_size, config, out_dtype, num_iters=10):
    ...
    return avg
# ============================================================
# END L2-FLUSH PATCH (part 1) -- tune() below has ONE further change: it

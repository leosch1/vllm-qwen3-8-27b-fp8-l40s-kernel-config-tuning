"""
Isolated kernel benchmark, cache-cycling variant: default vs. groupfix
(15's hand-patched config), both timed under the SAME weight-tensor-cycling
pressure (17's CyclingLaunchCounter design, 64 distinct B copies per point)
used for 19's cache-aware-vs-default cycling comparison -- lets the two
"fixed" configs (hand-patched groupfix, real corrected-script cache-aware)
be compared apples-to-apples under the same regime and the same grid.
...
def main():
    ...
    for N, K in SHAPES:
        ...
        print("| M | type | nearest anchor | default_cycled (us) | groupfix_cycled (us) | speedup |")
        print("|---:|---|---:|---:|---:|---:|")
        for M, ptype in points:
            ...
            groupfix_us = benchmark_config_cycling(

...
# level; results/e2e-comparison.json and results/full-metrics-table.json
# hold the output tok/s (and TTFT/TPOT) delta between a default-config run
# and an l2-flush-tuned-config run of this same sweep.
set -euo pipefail
